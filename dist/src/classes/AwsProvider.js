...
class AwsProvider {
  ...
  getCloudFormationReference(value) {
    return import_core.Stack.of(this.stack).resolve(value);
  }
  async request(service, method, params) {
    return await this.legacyProvider.request(service, method, params);
  }
}
